...
CoreRobin is under active development. Security fixes are applied to the current `main` branch.
...
CoreRobin temporarily accepts [GHSA-wrw7-89jp-8q8g](https://github.com/advisories/GHSA-wrw7-89jp-8q8g) (`RUSTSEC-2024-0429`) as a tolerable upstream risk.

- The affected `glib 0.18.5` package is a Linux-only transitive dependency of Tauri 2's GTK3 runtime.
- The affected `glib::VariantStrIter` iterator API is not called directly by CoreRobin.
