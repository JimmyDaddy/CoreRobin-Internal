    ...
    translation: {
      ...
      diagnosis: {
        ...
        recommendations: {
          ...
          open_cleanup: {
            title: "建议打开空间清理助手",
            description: "先预览空间去向；只有拖入清理篮并再次确认的内容才会移入系统废纸篓。",
            action: "打开清理助手",
          },
          open_network: {
            title: "建议核对联网活动",
      ...
      cleanup: {
        ...
        map: {
          kicker: "空间地图",
          title: "空间都去了哪里",
          description: "扇形面积按实际文件大小计算。点击进入目录，拖动扇区到清理篮收集待处理内容。",
          allScanned: "全部扫描结果",
          ...
          basket: {
            ...
            remove: "从清理篮移除 {{name}}",
            clear: "清空",
            completed: "已将 {{movedCount}} 项移入废纸篓",
            partial: "已移入 {{movedCount}} 项，{{failedCount}} 项未能处理",
          },
          freshness: {
            cached: "正在显示上次扫描结果",
        ...
        trashDialog: {
          ...
          reviewConfirmTitle: "我已经检查了需要确认的内容",
          reviewConfirmDescription: "下载文件、配置和个人数据可能无法重新生成，请确认不再需要。",
    ...
    translation: {
      ...
      diagnosis: {
        ...
        recommendations: {
          ...
          open_cleanup: {
            ...
            description: "Preview where space went first. Only items dragged into the basket and confirmed again are moved to the system Trash.",
      ...
      cleanup: {
        ...
        map: {
          ...
          description: "Sector area represents measured file size. Click to enter a folder, or drag a sector into the cleanup basket.",
          ...
          basket: {
            ...
            clear: "Clear",
            completed: "Moved {{movedCount}} items to Trash",
            partial: "Moved {{movedCount}} items; {{failedCount}} could not be handled",
          },
          freshness: {
        ...
        trashDialog: {
          ...
          reviewConfirmTitle: "I reviewed the items that require confirmation",
          reviewConfirmDescription: "Downloads, configuration, and personal data may not be reproducible. Confirm that you no longer need them.",
