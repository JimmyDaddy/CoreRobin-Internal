...
export default interface Resources {
  ...
  "cleanup": {
    ...
    "deleteDialog": {
      ...
      "errors": {
        ...
        "cleanup_trash_unavailable": "CoreRobin 当前无法安全打开系统废纸篓，请改用直接删除或稍后重试。",
  ...
  "network": {
    ...
    "quality": {
      "checking": "正在检查…",
      "description": "检查 DNS、连接延迟、抖动、丢包和当前联网状态。",
      "dns": "DNS",
      "empty": "尚未执行质量检查，不会在后台持续探测。",
      "eyebrow": "按需网络检查",
      "jitter": "抖动",
      "latency": "平均延迟",
      "loss": "丢包",
      "method": "延迟和丢包由 6 次 TCP 连接探测估算，不使用需要提权的原始数据包。",
      "run": "开始检查",
      "status": {
        "limited": "连接受限",
        "offline": "无法联网",
