...
export default interface Resources {
  ...
  "toolbox": {
    ...
    "image": {
      ...
      "manifestCancelled": "Manifest 检查已取消；未生成正式报告。",
      "manifestFailed": "Manifest 解析失败。",
      "manifestInputReleaseUnconfirmed": "Manifest 输入资源释放未确认：{{message}}",
      "manifestReadyBrowser": "本地 manifest 摘要已生成；未联网、未验证签名或信任链。下载的是显式检查报告。",
      "manifestReadyNative": "本地 manifest 摘要已生成；解析与信任状态分开显示，信任仍为 unknown。请在 10 分钟内正式另存报告。",
      "manifestSelected": "本地 manifest 材料“{{name}}”已选择；不会联网或保存路径。",
      "manifestTooLarge": "Manifest 材料不能超过 4 MiB。",
      ...
      "nativeManifestHint": "开始检查后由原生选择器签发 manifest token。",
      ...
      "selectManifest": "选择 manifest JSON",
