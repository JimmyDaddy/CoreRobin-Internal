...
describe("app navigation", () => {
  it("accepts only known application views", () => {
    ...
    expect(isActiveView("applications")).toBe(true);
  ...
  it("rejects malformed daily requests and covers every view eyebrow", () => {
    ...
    expect(Object.keys(PROFESSIONAL_VIEW_EYEBROW)).toHaveLength(12);
    expect(PROFESSIONAL_VIEW_EYEBROW.assistant).toBe("ai:title");
  });
